...
void MemoryManager::RegisterAllocator(std::shared_ptr<AllocatorData> allocatorData)
{
...
void MemoryManager::UnRegisterAllocator(std::shared_ptr<AllocatorData> allocatorData)
{
